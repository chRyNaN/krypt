...
internal class SHA224Or256HashFunction(
    ...
    /**
     * Represents the "ROTL^n(x)" "word" operation defined in the
     * [SHA-2 Specification](https://datatracker.ietf.org/doc/html/rfc4634#section-3) section 3, letter e. This
     * operation is referred to as "circular left shift".
     *
     * ```
     ...
     * @param [w] The bit size of the [x] value. Defaults to 32-bit which is used for SHA-224 and SHA-256.
     */
    private fun ROTL(x: Int, n: Int, w: Int = 32): Int =
        (x shl n) or (x ushr (w - n))
