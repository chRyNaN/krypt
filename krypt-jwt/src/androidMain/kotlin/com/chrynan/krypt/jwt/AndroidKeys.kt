...
actual fun Keys.generateSecretKeyFor(algorithm: SignatureAlgorithm): Key =
    io.jsonwebtoken.security.Keys.secretKeyFor(algorithm.toAndroidSignatureAlgorithm()).toMultiplatformKey()

actual fun Keys.generateKeyPairFor(algorithm: SignatureAlgorithm): KeyPair<Key, Key> =
    io.jsonwebtoken.security.Keys.keyPairFor(algorithm.toAndroidSignatureAlgorithm()).toMultiplatformKeyPair()
